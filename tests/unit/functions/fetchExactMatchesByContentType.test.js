const fetchExactMatchesByContentType = require('../../../devhub-search-service/functions/fetchExactMatchesByContentType.js');
...
test('gets database details from SEARCHDB context values', async () => {
    await fetchExactMatchesByContentType(content,searchText);
